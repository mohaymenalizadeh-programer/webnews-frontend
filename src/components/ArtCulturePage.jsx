...
function ArtCulturePage() {
  ...
  const handleSearchSubmit = (e) => {
    ...
    setLoading(true);
    axios.get(`${API_BASE}/api/artculture/?search=${encodeURIComponent(searchQuery)}`)
      .then(res => {
          ...
          <div className="nod-grid-right">
            ...
            >
              ...
              newsList.map((item, index) => (
                <div key={index} className="nod-news-card" onClick={() => registerView('artculture', item.slug)}>
